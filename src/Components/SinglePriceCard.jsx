...
const SinglePriceCard = ({ price }) => {
  return (
    <div
      className={`flex flex-col p-6 space-y-6 rounded shadow sm:p-8  w-sm text-base-100 hover:-translate-y-3.5 ease-linear transition-all  ${
        price.tag == "Most Popular"
          ? "bg-secondary/80 scale-110 "
          : " bg-primary/80"
      }`}
    >
